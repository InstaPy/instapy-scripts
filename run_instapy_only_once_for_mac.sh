...
then
   ...
   /Users/ishandutta2007/.pyenv/shims/python `dirname "$0"`/../Instapy/quickstart_templates/$TEMPLATE_NAME -u myuusername -p mypwd --headless-browser --disable_image_load
fi
